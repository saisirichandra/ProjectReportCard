...
contract ReportCard{
    ...
    function LandRecord(string newName,string newRollNo,string StudStream,uint newSub1Marks,uint newSub2Marks,uint newSub3Marks,uint newSub4Marks,string CurrentStatus)public{
    Name = newName;
    RollNo = newRollNo;
    Stream = StudStream;
